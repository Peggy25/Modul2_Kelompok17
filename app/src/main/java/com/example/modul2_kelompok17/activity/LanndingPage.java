...
import com.example.modul2_kelompok17.adapter.OnBoardingAdapter;
import com.google.android.material.button.MaterialButton;

import java.util.ArrayList;
import java.util.List;

public class LanndingPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lannding_page);
    ...
    private void setupOnboardingItems() {
        ...
        landingpage1.setImage(R.drawable.logolab);
        ...
        landingpage2.setImage(R.drawable.logolab);
        ...
        landingpage3.setImage(R.drawable.logolab);
